    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="escritorio.php" class="logo">
          ...
          <span class="logo-mini"><b>SCD</b></span>
            ...
            <?php
              ...
              if($_COOKIE['ABM'] == 1)
              {
                ...
                '<li class="treeview">
                    ...
                    <li><a href="jurisdiccion.php"><i class="fa fa-circle-o"></i> Jurisdicciones</a></li>
                    <li><a href="entidades.php"><i class="fa fa-circle-o"></i> Entidades</a></li>
                    <li><a href="documentacion.php"><i class="fa fa-circle-o"></i> Documentación</a></li>
                    </ul>
                  </li>'
                 ;
              }
